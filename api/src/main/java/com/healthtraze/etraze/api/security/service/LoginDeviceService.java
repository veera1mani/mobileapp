...
import com.healthtraze.etraze.api.security.repository.DeviceMetadataRepository;
...
public class LoginDeviceService {
    ...
    public LoginDeviceService(DeviceMetadataRepository deviceMetadataRepository,
    ...
    public void verifyDevice(User user, HttpServletRequest request) throws IOException, GeoIp2Exception {
        ...
        DeviceMetadata existingDevice = findExistingDevice(user.getUserId(), deviceDetails, location);
    ...
    private DeviceMetadata findExistingDevice(String userId, String deviceDetails, String location) {
